...
// Delegación de eventos para el logout y menú hamburguesa
document.addEventListener('click', (e) => {
  ...
  if (hamburgerBtn && (hamburgerBtn.contains(e.target) || e.target === hamburgerBtn)) {
    mobileMenu.classList.remove('hidden');
  }
  if (closeMobileMenu && (closeMobileMenu.contains(e.target) || e.target === closeMobileMenu)) {
    mobileMenu.classList.add('hidden');
  }
  if (mobileMenuOverlay && (mobileMenuOverlay.contains(e.target) || e.target === mobileMenuOverlay)) {
    mobileMenu.classList.add('hidden');
  }
});
